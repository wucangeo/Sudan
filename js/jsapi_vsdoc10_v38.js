...
esri.IdentityManager = function () {
    ...
    /// <field name="riskInfowindow" type="dijit.Dialog">Dialog box widget used to challenge the user for their credentials when the application attempts to access a secure resource.</field>
};
